				...
				<div class="col-12">
					<div class="card">
						<?php 
							...
							echo form_open_multipart('Capel/Update_peremajaan/'.$id_capel,$attributes);
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="mb-3">	
										<label class="control-label">Tgl Peremajaan Pelanggan</label>
										<input type="date" class="form-control" name="tgl_peremajaan" 
										value="<?php 
										if(set_value('tgl_peremajaan')!='') 
											echo set_value('tgl_peremajaan');
										else
											echo $tgl_peremajaan;
										?>"/>
									</div>
									<?php echo form_error('tgl_peremajaan'); ?>
								</div>	
							</div>						
