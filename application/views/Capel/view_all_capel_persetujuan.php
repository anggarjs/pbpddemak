      				...
      				<div class="card">
      					<div class="card-header bg-info">
      						<h4 class="card-title text-white">
      							Data Calon Pelanggan Perlu Persetujuan UP3
      						</h4>
      					</div>
      					<div class="card-body">
      									...
      									<tbody>
      										<?php foreach ($data_capel->result() as $data) : ?>
      											<tr>
      												...
      												<td><?= $data->nama_ulp; ?></td>
      												<td><?= date_format(date_create($data->tgl_permohonan_acc), "d-m-Y"); ?></td>
													<td><?= $data->no_permohonan_acc; ?></td>
