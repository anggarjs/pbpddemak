      				...
      				<div class="card">
      					<div class="card-header bg-info">
      						<h4 class="card-title text-white">
      							Data Kebutuhan Tiang Plgn Siap Bayar
      						</h4>
      					</div>
      					<div class="card-body">
											...
											<tr>
												<td>
													<div class="d-flex justify-content-around">
														<a href="<?php echo base_url('Logistik/detailTibet_kurang/') . $data->id_detail_mdu; ?>">
															<span style="position: relative; bottom:2px;" class="text-info"><i data-feather="edit"></i></span>
														</a>
													</div>
												</td>												
												<td><?= $data->nama_detail_mdu; ?></td>
												<td><?= number_format($data->total_kebutuhan); ?></td>
												<td><?= $data->satuan; ?></td>
